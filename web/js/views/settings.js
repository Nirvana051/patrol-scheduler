...
const GROUPS = [
  ...
  { title: 'TTS 播报', keys: [['TTS_ENGINE', '引擎', 'select:edge,command,none', 'edge 需联网；none 只推文本让浏览器念'], ['TTS_VOICE', 'edge 声音', 'text', 'zh-CN-XiaoxiaoNeural / zh-CN-YunxiNeural'], ['TTS_COMMAND', 'command 模板', 'text', '{text} {out}，如 espeak-ng -v cmn -w {out} {text}'], ['TTS_SINKS', '汇出', 'text', '逗号分隔：browser,local,zmq,webhook'], ['TTS_ZMQ_ENDPOINT', 'robot-audio ZMQ', 'text', 'tcp://<robot-ip>:5555（需机器人端支持 play_tts）'], ['TTS_WEBHOOK_URL', 'Webhook', 'text', ''], ['TTS_TIMEOUT', '合成超时 (s)', 'number', '外部 TTS 卡住时最多等这么久，超时记错误、执行继续']] },
